...
def insert_data(data):
    ...
    for item in data:
        ...
        query = f"SELECT COUNT(*) FROM monitoria2clixviavarejo WHERE COD_MONITORIA = '{cod_monitoria}'"
        ...
        if count == 0:
            ...
            insert_query = """
                INSERT INTO monitoria2clixviavarejo (
                    COD_MONITORIA,
                    data_avaliacao,
                    cliente,
                    campanha,
            ...
            print(f"Dados duplicados: COD_MONITORIA = {cod_monitoria}")
